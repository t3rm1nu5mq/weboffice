            ...
            <form id="delete-log-form" action="{{ route('log-viewer::logs.delete') }}" method="POST">
                ...
                <div class="modal-content">
                    <div class="modal-header">
                        <h5 class="modal-title">Log fájl törlése</h5>
                    ...
                    <div class="modal-footer">
                        <button type="button" class="btn btn-sm btn-secondary mr-auto" data-dismiss="modal">Bezárás</button>
                        <button type="submit" class="btn btn-sm btn-danger" data-loading-text="Loading&hellip;">Fájl törlése</button>
                    </div>
                </div>
            </form>
        </div>
        ...
        $(function () {
            ...
            $("a[href='#delete-log-modal']").on('click', function(event) {
                ...
                deleteLogModal.find('.modal-body p').html(
                    'Biztos benne, hogy <span class="badge badge-danger">TÖRLI</span> a <span class="badge badge-primary">' + date + '</span> fájlt?'
                );
