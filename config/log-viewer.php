<?php
    ...
    return [
        ...
        'pattern' => ['prefix' => Filesystem::PATTERN_PREFIX,    // 'laravel-'
        ...
        'menu' => ['filter-route' => 'log-viewer::logs.filter',
